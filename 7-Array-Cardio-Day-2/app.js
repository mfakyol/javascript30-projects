...
findByIdButton.addEventListener('click', (e) => {
    ...
    findByIdAnswer.innerHTML = comments.find((comment) => comment.id == findByIdInput.value).text
})
...
findByIndexButton.addEventListener('click', (e) => {
    const index = comments.findIndex(comment => Comment.id ==findIndexInput.value)
